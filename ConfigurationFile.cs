        ...
        {
            {
                ...
                pvpMinimapPlayersListRefresh = config("2 - PvP Settings", "Map Players List Refresh", 30, new ConfigDescription("Time in seconds to refresh the players list in the map."));
